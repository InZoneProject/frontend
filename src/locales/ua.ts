export const ua = {
    ...
    joinOrganization: {
        ...
        description: 'Відкрийте це запрошення в Android застосунку InZone. Там ми перевіримо ваш акаунт співробітника і статус згоди.',
        openInApp: 'Відкрити в застосунку',
        missingToken: 'Посилання запрошення некоректне або без токена.',
        androidRequired: 'Згода на обробку даних підтверджується вже в Android застосунку, коли відомий ваш акаунт співробітника.'
    },
    globalAdmin: {
        inviteSection: {
